    ...
    return (
        <Box>
            <Box display='flex' gap={1}>
                <LinearProgressWithLabel label='LP' minvalue={50} maxvalue={100} value={50} />
                <LinearProgressWithLabel label='MP' minvalue={50} maxvalue={100} value={50} />
                <LinearProgressWithLabel label='AP' minvalue={50} maxvalue={100} value={50} />
            </Box>
        </Box>
    );
}
...
function CampaignGMDashboard(): ReactElement {
    ...
    return <Box>DASHBOARD DO GM</Box>;
}
