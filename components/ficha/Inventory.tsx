...
import type { Ficha, LineageNames, Weapon, Armor, Item as ItemType } from '@types'
...
const Inventory = memo(({ disabled }: { disabled?: boolean }): ReactElement => {
    ...
    const [ weaponItem, setWeaponItem ] = useState<Partial<Weapon<'Leve' | 'Pesada'>>>({})
            ...
            armor: <>
                ...
                <FormControl fullWidth>
                    ...
                    <Select
                        ...
                        label="Raridade"
                        onChange={e => { setArmorItem(state => ({ ...state, rarity: e.target.value })) }}
                    >
                        <MenuItem value='Nenhuma'>Nenhuma</MenuItem>
                        <MenuItem value='Comum'>Comum</MenuItem>
                        <MenuItem value='Incomum'>Incomum</MenuItem>
            ...
            item: <>
                ...
                <FormControl fullWidth>
                    ...
                    <Select
                        ...
                        label="Raridade"
                        onChange={e => { setItemObj(state => ({ ...state, rarity: e.target.value })) }}
                    >
                        <MenuItem value='Nenhuma'>Nenhuma</MenuItem>
                        <MenuItem value='Comum'>Comum</MenuItem>
                        <MenuItem value='Incomum'>Incomum</MenuItem>
